...
app.register_blueprint(admin_reports_bp, url_prefix='/api/admin_reports')
...
def seed_data():
    ...
    if Users.query.first() is None:
        ...
        units = [
            Unit(tower_id=tower1.id, unit_id='A-101', floor=1, bedrooms=2, bathrooms=2, 
                 area_sqft=900, rent=5000, status='available',
                 description='Cozy 1BHK with city view',
                 image_url='https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800'),
            Unit(tower_id=tower1.id, unit_id='A-102', floor=1, bedrooms=3, bathrooms=2, 
                 area_sqft=1500, rent=8000, status='available',
            ...
            Unit(tower_id=tower2.id, unit_id='B-301', floor=3, bedrooms=3, bathrooms=3, 
                 area_sqft=1800, rent=10000, status='available',
